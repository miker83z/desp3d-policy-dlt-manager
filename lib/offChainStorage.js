...
class OffChainStorage {
  constructor(hostOptions, verbose) {
  ...
  async publish(payload) {
    if (this.verbose) console.log('[IPFS] Publishing payload');
    ...
    if (this.verbose) console.log('[IPFS] Published ', result.cid.toString());
    return result.cid.toString();
  }

  async retrieve(cid) {
    if (this.verbose) console.log('[IPFS] Retrieving ', cid);
